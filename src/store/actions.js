...
const actions = {
  async getHistory ({ commit }) {
    ...
    const values = await Vue.API.getHistory()
  ...
  async getHistoryLaunches ({ commit }, year) {
    ...
    const launches = await Vue.API.getHistoryLaunches(year)
  ...
  async getAllUpcomingLaunches ({ commit }) {
    ...
    const launches = await Vue.API.getAllUpcomingLaunches()
  ...
  async getAgenciesInfo ({ commit }) {
    ...
    const [agencies, agencyTypes, agencyContinents] = await Vue.API.getAgenciesInfo()
  ...
  async getAgencyAllLaunches ({ commit }, id) {
    ...
    const launchesById = await Vue.API.getAgencyAllLaunches(id)
  ...
  async getSpaceXLaunches ({ commit }) {
    ...
    const [allLaunches, officialLaunches, locations] = await Vue.API.getSpaceXLaunches()
    commit(types.SET_AGENCY_LAUNCHES, {
      id: config.SPACEX_ID,
      data: allLaunches,
  ...
  async getLaunchDetails ({ commit }, id) {
    const data = await Vue.API.getLaunchDetails(id)
  ...
  async getMissionTypes ({ commit }) {
    ...
    const missionTypes = await Vue.API.getMissionTypes()
  ...
  async getRocket ({ commit }, name) {
    ...
    const rocket = await Vue.API.getRocket(name)
  ...
  async getPresentYearLaunches ({ commit }) {
    ...
    const presentYearLaunches = await Vue.API.getPresentYearLaunches()
